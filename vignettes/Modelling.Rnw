...
mene.df <- mene.df[mene.df$year != "Y1617" & mene.df$year != "Y1718",]
require(arm)
require(xtable)
require(effects)
...
mene.df$year <- factor(mene.df$year, levels = c("Y0910", "Y1011", "Y1112", "Y1213", "Y1314", "Y1415", "Y1516"))
...
>>>>>>> 6b4a096aecac16894f18ff1aef5573b2a48cf99c
<<fitmodels, fig=FALSE, echo=FALSE, results=hide>>=
mene.df$year <- factor(mene.df$year, levels = c("Y0910", "Y1011", "Y1112", "Y1213", "Y1314", "Y1415", "Y1516"))
mene.df$marstat[mene.df$marstat == "NA"] <- NA
mene.df$marstat <- droplevels(mene.df$marstat)
...
m1 <- glm(q1_binary ~ age + sex + age:sex + car + seg + marstat + ethnicity_5 + child_in_hh + adults_in_hh + year, 
          family = binomial, data = mene.df[mene.df$year != "Y1617" | mene.df$year != "Y1718",])
m17 <- glm(q17_binary ~ age + sex + age:sex + car + seg + marstat + ethnicity_5 + child_in_hh + adults_in_hh + year, 
          family = binomial, data = mene.df[mene.df$year != "Y1617" | mene.df$year != "Y1718",])
@
...
n <- length(m17$linear_predictors
@

In total, \Sexpr{n} data points were used to fit this model.
